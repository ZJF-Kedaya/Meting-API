...
新增Vercel部署，适配QQ音乐Cookie，修复QQ音乐search接口。由于QQ音乐Cookie每三天过期，可以搭配QQ音乐保活工具[@qqmusic-keeper](https://github.com/ZJF-Kedaya/qqmusic-keeper)使用，可自动刷新Cookie并更新到Vercel环境变量。有用的话麻烦点个Star，谢谢🤞❤️
...
- 🐳 Docker 部署支持
- ▲ Vercel Serverless 部署支持(支持 QQ音乐 Cookie)
- 📝 结构化 JSON 日志输出
